...
export default function ViewDetalPosts({ params }: { params: string }) {
  ...
  // Dalam aplikasi nyata, Anda akan mengambil data post berdasarkan
  const post = {
    title:
      ...
      <article className="max-w-3xl mx-auto ">
        ...
        <div className="my-8">
          <div className="flex items-center gap-2">
            ...
            <ShareButtons
              url={`https://yourblog.com/post/${post.slug}`}
              title={post.title}
            />
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              <Badge key={tag}>
                <Link href={`/tag/${tag.toLowerCase().replace(/\s+/g, "-")}`}>
                  {tag}
                </Link>
              </Badge>
            ))}
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Seorang pengembang web dengan pengalaman lebih dari 5 tahun
                dalam membangun aplikasi web modern menggunakan React dan
                Next.js.
              </p>
              <div className="mt-2">
                <Button size="sm">Lihat Semua Artikel</Button>
              </div>
            </div>
          </div>
        </Card>
